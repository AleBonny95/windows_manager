...
class WM extends react_1.Component {
    ...
    constructor(props) {
        super(props);
        this.wid = props.wid ? props.wid : (0, uuid_1.v4)();
        this.state = {
            action: 0x0,
            update: 0,
            fullscreen: false,
    ...
    render() {
        ...
        const onMouseDown = fullscreen ?
            ...
            (e) => { this.setState({}, () => { if (this.props.onMouseDown)
                this.props.onMouseDown(this.state); }); };
        return ReactDOM.createPortal(React.createElement(styled_1.Wrapper, { id: this.wid, style: style, ref: onRef, isActive: isActive, className: className, onMouseDown: onMouseDown },
            this.renderHeader(),
            this.renderContent(),
