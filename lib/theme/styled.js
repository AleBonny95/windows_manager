...
exports.MoonIcon = exports.SunIcon = exports.MaxiIconBootstrap = exports.MinIconBootstrap = exports.CloseIconBootstrap = exports.MinIcon = exports.FullscreenIcon = exports.CloseIcon = exports.Icons = exports.Button = exports.BottomRightResizeHandle = exports.BottomResizeHandle = exports.RightResizeHandle = exports.WindowTitle = exports.ContentWrapper = exports.WindowHeader = exports.WrapperHeader = exports.Wrapper = exports.Container = exports.bottomRightResizeCursor = exports.bottomResizeCursor = exports.rightResizeCursor = exports.defaultMinHeight = exports.defaultMinWidth = void 0;
const styled_components_1 = __importDefault(require("styled-components"));
const Sun_1 = require("@styled-icons/boxicons-solid/Sun");
const Moon_1 = require("@styled-icons/heroicons-solid/Moon");
const bootstrap = __importStar(require("@styled-icons/bootstrap"));
//-------------------CONST-------------------//
...
exports.Wrapper = styled_components_1.default.div `
  ...
  min-height: ${({ minHeight }) => minHeight ? minHeight + `px` : exports.defaultMinHeight + `px`};
  user-select: none;
  `;
...
`;
exports.CloseIconBootstrap = (0, styled_components_1.default)(bootstrap.XCircleFill) `
  width: 1.5rem;
  height: 1.5rem;
  cursor: pointer;
  float: right;
...
exports.MinIconBootstrap = (0, styled_components_1.default)(bootstrap.DashCircleFill) `
  width: 1.5rem;
  height: 1.5rem;
  cursor: pointer;
  float: right;
...
exports.MaxiIconBootstrap = (0, styled_components_1.default)(bootstrap.StopCircleFill) `
  width: 1.5rem;
  height: 1.5rem;
  cursor: pointer;
  float: right;
...
/* `
  color: ${({ theme }) => theme.text};
`; */
exports.SunIcon = (0, styled_components_1.default)(Sun_1.Sun) ``;
exports.MoonIcon = (0, styled_components_1.default)(Moon_1.Moon) ``;
